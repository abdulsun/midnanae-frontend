...
import { InputRow } from "./edit.inputsell";
...
export default function Editpurch() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/customer/name")
      .then((res) => {
        setFarmer(res.data);
      })
      .catch((error) => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:5000/sell/${id}`)
      .then((res) => {
        setPush(res.data);
      })
      .catch((error) => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:5000/sell/dtsell/${id}`)
      .then((res) => {
  ...
  const handleAddproduct = () => {
    axios.post("http://localhost:5000/sell/create-dtsell", {
      id:id,
